...
CUDA_VISIBLE_DEVICES=0 python snli_kmeans_cuda.py --cuda --snlipath /mnt/hdd/saxon/snli_1.0/ --modelpath /mnt/hdd/saxon/roberta-nli/weights/roberta_nli/ --outpath /mnt/hdd/saxon/roberta-nli/
...
def main(snlipath, modelpath, outpath, partition, debug, hides2, perp, cuda, plot, redo_tsne, n_clusters, threshold):
    ...
    kms = KMeans(n_clusters=n_clusters, verbose=2).fit(X_tsne)
