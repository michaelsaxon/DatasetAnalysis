...
def hist_by_L2_bin(df):
    ...
    sns.histplot(df[df["outlier"] == True], x="mus", element="step", ax = axs[0], bins=50, binrange=(0,1), hue="labels", color="orange", kde=True)
    sns.histplot(df[df["outlier"] == False], x="mus", element="step", ax = axs[1], bins=50, binrange=(0,1), hue="labels", color="blue", kde=True)
